...
('Baby in His Mothers arms, sucking his finger', 'Mary Cassatt', 716, 946, 'https://uploads6.wikiart.org/images/mary-cassatt/baby-in-his-mother-s-arms-sucking-his-finger-1889.jpg!Large.jpg', 1889 ),
...
('Babys First Caress', 'Mary Cassatt', 806, 1000, 'https://uploads6.wikiart.org/images/mary-cassatt/baby-s-first-cess-1891.jpg!Large.jpg', 1891 ),
...
con.connect(function (err) {
  ...
  con.query(sql, function (err, result) {
    if (err) throw err;
    console.log("Table creation `artescape` was successful!");
